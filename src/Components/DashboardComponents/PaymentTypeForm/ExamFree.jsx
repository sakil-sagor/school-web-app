        ...
        <div className="bg-blue-300 p-4 rounded-md">
          <div className="flex justify-between mb-2">
            ...
            <div>
              {studentResult && (
                <button
                  className={`p-2 rounded  cursor-pointer bg-blue-500 text-white hover:bg-blue-700 `}
          ...
          <form onSubmit={handleSubmit} className="mt-4">
            <div className="flex ">
              ...
              <div className="mx-4">
                <input
                  className="border text-right bg-white border-gray-500 ml-1 w-24 rounded p-1"
                  type="number"
                  id="feeAmount"
                  name="feeAmount"
