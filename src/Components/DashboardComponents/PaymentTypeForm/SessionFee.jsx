...
const SessionFee = ({ paymentType, searchResult, againFetch, setAgainFetch }) => {
        ...
        <div>
            {
                ...
                <div className='bg-blue-300 p-8 rounded-md '>
                    ...
                    <div className='flex justify-center py-2'>
                        ...
                        <div>
                            <p>Admission Fee : {studentResult?.payment?.sessionfee?.admission}</p>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className='mt-4'>
                        <div className='flex '>
                            <div className=''>
                                ...
                                >
                                    <option className='' value='' disabled selected>--Others Fee--</option>
                            ...
                            <div className='mx-4 flex items-center'>
                                ...
                                <input className='border text-right bg-white border-gray-500 ml-1 w-full rounded p-1 inline-block mr-2' type="number" id="sessionFee" name="sessionFee" onBlur={e => setMoney(e.target.value)} /><span> Tk</span>
                            </div>
                            <div>
