            ...
            <div className="container mx-auto px-2">
                ...
                <div className="w-full max-w-screen-lg mx-auto bg-white  mt-8">
                    <div className="overflow-x-auto sm:px-1 md:p-8">
                        <div className="py-6">
                            <h2 className="text-green-600 font-semibold text-2xl "><AiFillDatabase className="inline mb-1"></AiFillDatabase> Committee Members</h2>
                            <div className="flex items-center justify-between mt-4 px-2">
                                <p>Total Result:{committees.length} <span>{""}</span></p>
                                <div>
                        ...
                        {loading ?
                            ...
                            <table className="w-full table-auto">
                                ...
                                <tbody>
                                    {
                                        committees.map((teacher, index) => <SingleTeacher key={teacher.id} index={index} teacher={teacher}></SingleTeacher>)
                                    }
                                </tbody>
