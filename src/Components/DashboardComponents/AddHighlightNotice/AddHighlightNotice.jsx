...
const AddHighlightNotice = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        console.log(title);
        try {
            const response = await axiosSecure.post('http://localhost:5000/api/v1/notice/highlightNotice', { title }, {
                headers: {
    ...
    //     setLoading(true)
    //     try {
    //         const response = await fetch('http://localhost:5000/api/v1/notice/highlightNotice', {
    //             method: 'POST',
    //             headers: {
    //                 'Content-Type': 'application/json',
    //             },
