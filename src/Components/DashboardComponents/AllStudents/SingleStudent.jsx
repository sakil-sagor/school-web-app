    ...
    <tr key={student._id} className={index % 2 === 0 ? "bg-[#f2f2f2]" : ""}>
      ...
      <td className="md:px-4 py-2  flex">
        <div
          ...
          className="cursor-pointer inline bg-green-700 text-white px-2 py-1 rounded hover:bg-green-800 text-sm mr-1"
        >
          <AiFillEye className=""></AiFillEye> <span>Profile</span>
        </div>
