...
const StaffSection = () => {
    ...
    const staffs = allstaff.filter(staff => (staff.title === "officeAsst" || staff.title === "mlss"))
                ...
                <div className="container mx-auto px-2">
                    ...
                    <div className="w-full max-w-screen-lg mx-auto bg-white  mt-8">
                        <div className="overflow-x-auto sm:px-1 md:p-8">
                            <div className="py-6">
                                <h2 className="text-green-600 font-semibold text-2xl "><AiFillDatabase className="inline mb-1"></AiFillDatabase> Stuffs list</h2>
                                <div className="flex items-center justify-between mt-4 px-2">
                                    <p>Total Result:{staffs.length} <span>{""}</span></p>
                                    <div>
