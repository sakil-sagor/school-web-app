      ...
      <div className="py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center">
          <div className="px-8">
            ...
            <div className="flex items-center my-4">
              ...
              <div>
                ...
                <p className="text-pink-600">Haybatnagar, Kishoreganj</p>
              </div>
            </div>
            <hr />
            <div className="flex items-center my-4">
            ...
            <div className="flex items-center my-4">
              ...
              <div>
                ...
                <p className="text-pink-600">Kishoreganj@gmail.com</p>
              </div>
            </div>
            <hr />
          </div>
          <div>
            <div>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d556.1837935362722!2d90.61450794914464!3d24.46990540593512!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2sbd!4v1696014600960!5m2!1sen!2sbd"
                width="100%"
                height="450"
                style={{ border: 0 }}
                allowfullscreen=""
