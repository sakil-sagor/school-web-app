            ...
            <div className="container mx-auto px-2">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4  full-width-all m-auto pb-8 px-2">
                    ...
                    <div className="col-sapn- ">
                        <Link to="/home">
                            <h1 className="text-xl font-bold text-white "> <span className="text-blue-300">Demo</span> High-School & College  </h1>
                        </Link>
                        <p className="py-8 text-white font-semibold">Join our free campaign and give the gift of life! Your donation can save up to three lives and help those in need.Join us today and help make a positive impact in your community!</p>
